...
<%!String[][] records = { 
			{ "1", "남", "name1@gmail.com", "베이직", "2022.01.08", "checkbox","checkbox","적용"},
			{ "2", "남", "name1@gmail.com", "베이직", "2022.01.08", "checkbox","checkbox","적용"}, 
			{ "3", "남", "name1@gmail.com", "베이직", "2022.01.08", "checkbox","checkbox","적용"},
			{ "4", "남", "name1@gmail.com", "베이직", "2022.01.08", "checkbox","checkbox","적용"}, 
			{ "5", "남", "name1@gmail.com", "베이직", "2022.01.08", "checkbox","checkbox","적용"},
			{ "6", "남", "name1@gmail.com", "베이직", "2022.01.08", "checkbox","checkbox","적용"}, 
			{ "7", "남", "name1@gmail.com", "베이직", "2022.01.08", "checkbox","checkbox","적용"}
	};
	int size = 0;
...
<body>
	<div id="todolist" style="float: left; width: 15%">
		...
		<div>
			...
			<li class="submit"><button type="button" class="btn btn-outline-primary" style="width: 50%">4. 회원관리</button></li>
			...
			<li>
				<div id="divPaging">
					...
					<c:forEach begin="1" end="${Math.ceil(size/page)}" var="item">
						<a href="<c:url value="/membership.jsp" >            
